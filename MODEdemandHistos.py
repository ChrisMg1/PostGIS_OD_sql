...
plt.xlabel('Demand PrT (car) model area [PAX/day]')
plt.ylabel('Frequency (n=' + format(len(df['demand_pkw'] + df['demand_pkwm']), ',') + ')')
plt.ylim( (pow(10,-0.5),pow(10,8)) )

plt.hist(df['demand_pkw'] + df['demand_pkwm'], edgecolor='darkgrey', bins = 'doane', log=True)
plt.savefig('C:/Users/chris/plots/demand_car_ALL.pdf', bbox_inches='tight', transparent=True) ## pdf for LaTeX
#plt.savefig('C:/Users/chris/plots/demand_car_ALL.png', dpi=1200, bbox_inches='tight', transparent=True) ## high-res for poster
plt.show()
plt.clf()
...
plt.hist(df['demand_put'], edgecolor='darkgrey', bins = 'doane', log=True)
plt.savefig('C:/Users/chris/plots/demand_put_ALL.pdf', bbox_inches='tight', transparent=True) ## pdf for LaTeX
...
plt.hist(df['demand_walk'], edgecolor='darkgrey', bins = 'doane', log=True)
plt.savefig('C:/Users/chris/plots/demand_walk_ALL.pdf', bbox_inches='tight', transparent=True) ## pdf for LaTeX
...
plt.hist(df['demand_bike'], edgecolor='darkgrey', bins = 'doane', log=True)
plt.savefig('C:/Users/chris/plots/demand_bike_ALL.pdf', bbox_inches='tight', transparent=True) ## pdf for LaTeX
