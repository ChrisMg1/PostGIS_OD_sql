...
COPY odpair_lvm2035_23712030_onlybav(ttime_put, ttime_prt, ttime_ratio, imp_ttime, directdist, imp_distance, demand_all_person_purged, imp_demand) TO 'C:\TUMdissDATA\odpair_lvm2035_23712030_onlybav_red_exp.csv' DELIMITER ',' CSV HEADER;
