...
SELECT * INTO TABLE odpair_LVM2035_23712030_onlyBAV_restored
...
select count(*) from odpair_LVM2035_23712030_onlyBAV_restored;
...
COPY odpair_LVM2035_23712030_onlyBAV_restored(ttime_put, ttime_prt, ttime_ratio, imp_ttime, directdist, imp_distance, demand_all_person_purged, imp_demand, imp_tot_scen1_common, imp_tot_scen2_society, imp_tot_scen3_technology, imp_tot_scen4_operator, imp_tot_scen5_societyTec) TO 'C:\TUMdissDATA\odpair_lvm2035_23712030_onlybav_exp.csv' DELIMITER ',' CSV HEADER;
COPY odpair_lvm2035_11856015_onlybav_groupedbf(u_ample_scen1_common, u_ample_scen2_society, u_ample_scen3_technology, u_ample_scen4_operator, u_ample_scen5_societyTec) TO 'C:\TUMdissDATA\odpair_lvm2035_11856015_onlybav_groupedBF_exp.csv' DELIMITER ',' CSV HEADER;
