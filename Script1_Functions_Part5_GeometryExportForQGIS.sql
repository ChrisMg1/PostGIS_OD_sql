...
select	(array_agg(fromzone_name))[1] as fromzone_name, -- make the from_zone an array, then only retain 1st element (sic! [1] not [0])
		...
		array_agg(ttime_put) as ttime_put,
		array_agg(ttime_prt) as ttime_prt,
...
select fromzone_name, tozone_name, u_ample_scen1_common, imp_ttime, imp_distance, imp_demand, ttime_ratio, ttime_put, ttime_prt, demand_all_person_purged, directdist, imp_tot_scen1_common, geom_point_fromod, geom_point_tood, odconnect
...
-- create top 10 in this scenario in separate 'scheme'
select fromzone_name, tozone_name, u_ample_scen2_society, imp_ttime, imp_distance, imp_demand, ttime_ratio, ttime_put, ttime_prt, demand_all_person_purged, directdist, imp_tot_scen2_society, geom_point_fromod, geom_point_tood, odconnect
...
-- create top 10 in this scenario in separate 'scheme'
select fromzone_name, tozone_name, u_ample_scen3_technology, imp_ttime, imp_distance, imp_demand, ttime_ratio, ttime_put, ttime_prt, demand_all_person_purged, directdist, imp_tot_scen3_technology, geom_point_fromod, geom_point_tood, odconnect
...
-- create top 10 in this scenario in separate 'scheme'
select fromzone_name, tozone_name, u_ample_scen4_operator, imp_ttime, imp_distance, imp_demand, ttime_ratio, ttime_put, ttime_prt, demand_all_person_purged, directdist, imp_tot_scen4_operator, geom_point_fromod, geom_point_tood, odconnect
...
-- create top 10 in this scenario in separate 'scheme'
select fromzone_name, tozone_name, u_ample_scen5_societytec, imp_ttime, imp_distance, imp_demand, ttime_ratio, ttime_put, ttime_prt, demand_all_person_purged, directdist, imp_tot_scen5_societytec, geom_point_fromod, geom_point_tood, odconnect
