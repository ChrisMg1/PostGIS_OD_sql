...
plt.hist(for_hist['demand_weight'], edgecolor='darkgrey')
...
plt.hist(for_hist['distance_weight'], edgecolor='darkgrey')
...
plt.hist(for_hist['ttime_weight'], edgecolor='darkgrey')
...
plt.hist(for_hist['cm_metric'], color = 'orange', edgecolor='darkgrey')
